...
export default function OperatorLogo({
  ...
  if (id === 'MTN_MOMO_CMR') {
    return <svg width={size} height={size} viewBox="0 0 100 100" aria-label="MTN Mobile Money">
  ...
  if (id === 'ORANGE_CMR') {
    return <svg width={size} height={size} viewBox="0 0 100 100" aria-label="Orange Money">
