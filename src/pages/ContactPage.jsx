...
export default function ContactPage() {
  ...
  const send = async () => {
    ...
    try {
      ...
      // Cache partagé — seulement au tout premier message d'une conversation
      // (question générique type FAQ, indépendante de l'historique ou du
      // profil précis de l'utilisateur qui la pose).
